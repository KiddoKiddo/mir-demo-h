...
def script():
    ...
    if (input_string == 'Dispatch_parts_NTX1000') :   #Dispatch Parts to NTX1000
    	...
    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission": "1cd195ef-1d35-11e8-ba33-f44d306f3f85"}, headers=headers)  #2.go to the wait position near warehouse
        print(r.text)
    	...
    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission": "e2f78da8-3d3b-11e8-99fb-f44d306f3f85"}, headers=headers)   #4.go to NTX1000 drop off position
        print(r.text)
    ...
    if (input_string == 'Bring_Empty_Trolley_NTX1000') :   #Bring back Empty Trolley from NTX1000 to warehouse
    	...
    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission": "5a44e279-3d3c-11e8-99fb-f44d306f3f85"}, headers=headers)  #2.go to NTX1000 waiting position
        print(r.text)


    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission": "9c4b4293-3d3c-11e8-99fb-f44d306f3f85"}, headers=headers)  #2.Pick up trolley from the NTX1000 machine
        print(r.text)
        ...
        headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission": "1cd195ef-1d35-11e8-ba33-f44d306f3f85"}, headers=headers)   #5.go to wait position near warehouse
        print(r.text)
        time.sleep(5)
    ...
    if (input_string == 'Charge_AGV') :   #AGV go to Charging station
    	...
    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission":"bdf70234-3d3e-11e8-99fb-f44d306f3f85"}, headers=headers)  #1.go to charging station
        print(r.text)

    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission":"7ffe916c-3d40-11e8-99fb-f44d306f3f85"}, headers=headers)  #1.docking to charging station
        print(r.text)


    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission":"950b1425-2724-11e8-9f01-f44d306f3f85"}, headers=headers)  #1.charginig the robot
        print(r.text)
    ...
    if (input_string == 'Pause_AGV') :   #Pause the AGV
    	headers = {'Content-type': 'application/json'}
        #r = requests.put('http://10.100.108.210:8080/v1.0.0/state', json ={'state':3}, headers=headers)
        #r = requests.get('http://10.100.108.210:8080/v1.0.0/state', json ={'state':1}, headers=headers)
        #r = requests.get('http://10.100.108.210:8080/v1.0.0/missions/{9c4b4293-3d3c-11e8-99fb-f44d306f3f85}')
        #r = requests.post('http://10.100.108.210:8080/v1.0.0/actions', json ={"action_type_id": 300, "mission_id" : "a4c19cdc-1d34-11e8-ba33-f44d306f3f85"}, headers=headers)  #1.charginig the robot
        r = requests.get('http://10.100.108.210:8080/v1.0.0/status', json ={"whitelist" : "string"}, headers=headers )
        print(r.text)
    ...
    if (input_string == 'CallforPartsStation') :       #Call for Parts from the warehouse
    	...
    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission": "fd2fc112-485a-11e8-9812-f44d306f3f85"}, headers=headers)  #2.go to wait position 2  near warehouse
        print(r.text)
    	...
    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission": "7f107423-e3a3-11e7-896e-f44d306f3f85"}, headers=headers)   #5.go to station one near assembly line
        print(r.text)
        time.sleep(5)
    ...
    if (input_string == 'DispatchPartsStation') :   #Ready for Dispatch from assembly line to warehouse
    	...
    	headers = {'Content-type': 'application/json'}
        r = requests.post('http://10.100.108.210:8080/v1.0.0/mission_queue', json ={"mission": "fd2fc112-485a-11e8-9812-f44d306f3f85"}, headers=headers)   #5.go to wait positio 2n near warehouse
        print(r.text)
        time.sleep(5)
